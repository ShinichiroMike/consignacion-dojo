...
from .views import PedidoTallajeDinamico, PedidoList, PedidoDetailList, PedidoCliente, CrearPedido, ElegirCliente, ElegirTalla, ProductoClienteList
...
urlpatterns = [
    ...
    url(r'^pedidos/testUrl/(?P<pk>\d+)/$', PedidoTallajeDinamico.as_view(), name='pedido_test_url'),
